...
namespace WebApplication1
{
    public partial class WebForm5 : Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            name.Text = (string)Session["profile"];
    ...
    protected void Save_clicked(object sender, EventArgs e)
    {
            ...
            conn.Open();
            string sqll = "Update employee set FirstName='" + first.Text + "',LastName='" + last.Text + "',age='" + ageboo.Text + "',sex='" + genboo.Text + "',address='" + addressboo.Text + "',email='" + exampleInputEmail1.Text + "',phone='" + phone.Text + "',job='" + rolebooo.Text + "',password='" + exampleInputPassword1.Text + "' where FirstName='" + name.Text + "'";
