<%@ Page Title="" Language="C#" MasterPageFile="~/officermaster.Master" AutoEventWireup="true" CodeBehind="arrest.aspx.cs" Inherits="WebApplication1.WebForm7" %>
        ...
        <div class="card card-default">
          ...
          <div class="card-body">
            ...
            <div class="form-group">
                  <label>Cell:</label>
                 <%-- <input type="text" class="form-control my-colorpicker1">--%>
               <asp:TextBox ID="cell" runat="server" class="form-control my-colorpicker1" required=""></asp:TextBox>
                </div>
           <div class="form-group">
                  <label>Address:</label>
                 <%-- <input type="text" class="form-control my-colorpicker1">--%>
             ...
             <div class="form-group">
                 ...
                 <%-- <input type="text" class="form-control my-colorpicker1">--%>
                   <asp:TextBox ID="emergency"  runat="server" class="form-control my-colorpicker1" required=""></asp:TextBox>
                </div>
             <div class="form-group">
             ...
             <div class="form-group">
                 ...
                 <%-- <input type="text" class="form-control my-colorpicker1">--%>
                   <asp:TextBox ID="crime"  runat="server" class="form-control my-colorpicker1" required=""></asp:TextBox>
                </div>
             ...
             <div class="col-lg-6">
                    <div class="btn-group w-100">
                     ...
                     <%-- <button type="submit" class="btn btn-primary col start">
                        ...
                        <asp:Button ID="adding" runat="server" Text="arrest" OnClick="button_clicked"  class="btn btn-primary col start"/>
